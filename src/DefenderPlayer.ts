...
export class DefenderPlayer extends Player {
    ...
    public pickUpFoodAtPosition: Position = null;
    ...
    private pickUpFoodAt(barbarianAssault: BarbarianAssault, pos: Position): void {
        const foodZone: FoodZone = barbarianAssault.map.getFoodZone(pos.x >>> 3, pos.y >>> 3);
